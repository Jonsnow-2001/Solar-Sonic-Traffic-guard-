...
if ($connection) {
    insertData($connection, $temperature, $humidity, $mq2_analog, $mq2_digital, $sound_analog,
     $sound_digital, $mq9_analog, $mq9_digital, $mq8_analog, $mq8_digital,$pm25_density, $pm10_density);
